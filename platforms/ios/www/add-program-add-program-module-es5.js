        ...
        value: function openStart(i) {
          ...
          if (this.myDate != '' && this.progDuration.length > 0) {
            if (this.repetatedDateCopy[this.indexForLive].is_live == true) {
              ...
              this.repetatedDateCopy[this.indexForLive].date = date; // Set hours, minutes and seconds

              console.log(date);
              console.log(date.toString()); // this.minutes = '';
              // this.hours = '';
                      ...
                      buttons: [{
                        ...
                        handler: function handler(data) {
                          ...
                          if (data.duration <= 0) {
                            ...
                            _this13.copyDateObj = _this13.dateObj;
                            ...
                            if (_this13.noEvent == true) {
                              ...
                              if (_this13.repetatedDateCopy[_this13.indexForLive].is_live == true) {// this.repetatedDateCopy[this.indexForLive].is_live = false;
                              } else {
