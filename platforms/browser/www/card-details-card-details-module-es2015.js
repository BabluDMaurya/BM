...
let CardDetailsPage = class CardDetailsPage {
    constructor(stripe, programService) {
        this.stripe = stripe;
...
CardDetailsPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_native_stripe_ngx__WEBPACK_IMPORTED_MODULE_2__["Stripe"], _services_program_service__WEBPACK_IMPORTED_MODULE_4__["ProgramService"]])
], CardDetailsPage);
