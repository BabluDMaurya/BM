...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["swiper-bundle-8bab85e6-js"], {
  /***/
  "./node_modules/@ionic/core/dist/esm/swiper.bundle-8bab85e6.js":
  /*!*********************************************************************!*\
    !*** ./node_modules/@ionic/core/dist/esm/swiper.bundle-8bab85e6.js ***!
    \*********************************************************************/
  ...
  /***/
  function node_modulesIonicCoreDistEsmSwiperBundle8bab85e6Js(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var Utils = {
      ...
      getTranslate: function getTranslate(el) {
        ...
        if (axis === 'x') {
          ...
          if (win$1.WebKitCSSMatrix) curTransform = transformMatrix.m41; // Crazy IE10 Matrix
        ...
        if (axis === 'y') {
          // Latest Chrome and webkits Fix
          if (win$1.WebKitCSSMatrix) curTransform = transformMatrix.m42; // Crazy IE10 Matrix
      ...
      if (params.loopFillGroupWithBlank) {
        ...
        if (blankSlidesNum !== params.slidesPerGroup) {
          for (var i = 0; i < blankSlidesNum; i += 1) {
            var blankNode = $(doc$1.createElement('div')).addClass("".concat(params.slideClass, " ").concat(params.slideBlankClass));
    ...
    var Device = function Device() {
      ...
      device.pixelRatio = win$1.devicePixelRatio || 1; // Export object
    ...
    function onTouchStart(event) {
      ...
      if (e.type !== 'touchstart') {
        ...
        if (doc$1.activeElement && $(doc$1.activeElement).is(data.formElements) && doc$1.activeElement !== e.target) {
    ...
    var Resize = {
      ...
      on: {
        init: function init() {
          ...
          win$1.addEventListener('resize', swiper.resize.resizeHandler); // Emit orientationchange
    ...
    function isEventSupported() {
      ...
      if (!isSupported && doc$1.implementation && doc$1.implementation.hasFeature // always returns true in newer browsers as per the standard.
...
//# sourceMappingURL=swiper-bundle-8bab85e6-js-es5.js.map