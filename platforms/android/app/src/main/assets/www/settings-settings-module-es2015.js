...
const routes = [
    ...
    {
        path: 'faq',
        loadChildren: () => Promise.all(/*! import() | faq-faq-module */[__webpack_require__.e("default~add-program-add-program-module~edit-program-edit-program-module~faq-faq-module~music-music-m~ec93f8e5"), __webpack_require__.e("faq-faq-module")]).then(__webpack_require__.bind(null, /*! ./faq/faq.module */ "./src/app/settings/faq/faq.module.ts")).then(m => m.FaqPageModule)
    },
    {
        path: 'contact-admin',
