...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["program-program-program-module"], {
  ...
  function srcAppProgramInviteRequestInviteRequestComponentScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = ".item-card ion-avatar {\n  border-radius: 0;\n  --border-radius: 0;\n  height: 75px;\n  width: 100px;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
    ...
    var InviteRequestComponent = /*#__PURE__*/function () {
      ...
      _createClass(InviteRequestComponent, [{
        ...
        value: function ngOnInit() {
          ...
          var params = null; // if (this.tabData.tab == 2) {
  ...
  function srcAppProgramProgramProgramModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _invite_request_invite_request_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ./../invite-request/invite-request.component */
    "./src/app/program/invite-request/invite-request.component.ts");
    /* harmony import */


    var _nutrition_list_pipe_module__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    ...
    /*! ionic2-calendar */
    "./node_modules/ionic2-calendar/index.js"); // import { HostingDropdownComponent } from '../hosting-dropdown/hosting-dropdown.component';
    ...
    ProgramPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _program_routing_module__WEBPACK_IMPORTED_MODULE_5__["ProgramPageRoutingModule"], _profile_components_modules__WEBPACK_IMPORTED_MODULE_7__["ComponentModule"], _nutrition_list_pipe_module__WEBPACK_IMPORTED_MODULE_9__["PipeModule"], ion2_calendar__WEBPACK_IMPORTED_MODULE_10__["CalendarModule"], // ProgramPageModule.forChild(ProgramPage),
      ionic2_calendar__WEBPACK_IMPORTED_MODULE_11__["NgCalendarModule"]],
      declarations: [_program_page__WEBPACK_IMPORTED_MODULE_6__["ProgramPage"], _invite_request_invite_request_component__WEBPACK_IMPORTED_MODULE_8__["InviteRequestComponent"]],
  ...
  function srcAppProgramProgramProgramPageScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = ".item-card ion-avatar {\n  border-radius: 0;\n  --border-radius: 0;\n  height: 75px;\n  width: 100px;\n}\n\nion-item {\n  margin-bottom: 5px;\n  border-radius: 4px;\n  --border-radius: 4px;\n}\n\n.calendar-days ion-segment-button {\n  min-width: 48px;\n  border: none;\n  color: rgba(0, 0, 0, 0.6);\n}\n\n.calendar-date ion-segment-button {\n  min-width: 58px;\n  border: none;\n  color: rgba(0, 0, 0, 0.6);\n}\n\n.calendar-slider .swiper-slide {\n  background: transparent;\n}\n\n.slideBack {\n  left: 10px;\n}\n\n.slideNext {\n  right: 10px;\n}\n\nion-avatar ion-skeleton-text {\n  border-radius: 4px;\n}\n\nion-label ion-skeleton-text {\n  height: 15px;\n}\n\n.lds-dual-ring {\n  display: inline-block;\n  width: 100%;\n}\n\n.lds-dual-ring:after {\n  content: \" \";\n  display: block;\n  width: 30px;\n  height: 30px;\n  margin: 8px;\n  border-radius: 50%;\n  border: 3px solid #27a69a;\n  border-color: #27a69a #f7f7f7 #27a69a #f7f7f7;\n  -webkit-animation: lds-dual-ring 1.2s linear infinite;\n          animation: lds-dual-ring 1.2s linear infinite;\n  margin: 10px auto;\n}\n\n@-webkit-keyframes lds-dual-ring {\n  0% {\n    transform: rotate(0deg);\n  }\n  100% {\n    transform: rotate(360deg);\n  }\n}\n\n@keyframes lds-dual-ring {\n  0% {\n    transform: rotate(0deg);\n  }\n  100% {\n    transform: rotate(360deg);\n  }\n}\n\n.no-data {\n  height: calc(100vh - 171px);\n}\n\nion-card {\n  border-bottom: 4px solid #f7f7f7;\n  box-shadow: none;\n  border-radius: 0;\n  --border-radious: 0;\n}\n\nion-card ion-item {\n  border-bottom: 1px solid #f7f7f7;\n  margin-bottom: 0;\n  box-shadow: 0px 2px 10px 0px rgba(34, 35, 58, 0.14);\n  box-shadow: 0px 2px 10px 0px rgba(0, 33, 30, 0.1);\n  --border-radius: 0;\n  --background: #FFF;\n  border-radius: 0;\n}\n\nion-card ion-item ion-label h3.list-person {\n  white-space: break-spaces;\n  overflow: hidden;\n  text-overflow: ellipsis;\n  display: -webkit-box;\n  -webkit-line-clamp: 2;\n  -webkit-box-orient: vertical;\n}\n\nion-card ion-list {\n  background: #f7f7f7;\n}\n\nion-card .timeline-list ion-item {\n  border-bottom: none;\n  --background: transparent;\n  box-shadow: none;\n}\n\nion-header ion-item.item-datetime {\n  margin: 0;\n}\n\nion-header ion-item.item-datetime ion-datetime {\n  padding: 0;\n}\n\nion-label.active p {\n  width: 18px;\n  height: 18px;\n  background: #FFF;\n  border-radius: 50%;\n  font-weight: 400;\n  font-size: 10px;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  color: #2bbbad;\n}\n\n.programCalendar {\n  text-align: center;\n}\n\n.programCalendar ion-item {\n  background: #2bbbad;\n  --background: #2bbbad;\n}\n\n.programCalendar ion-item ion-label {\n  text-align: center;\n  text-transform: uppercase;\n  font-size: 13px;\n  font-weight: 500;\n  color: #FFFf;\n}\n\n.programCalendar ion-item ion-label p {\n  padding: 0;\n  width: 24px;\n  height: 24px;\n  margin: 10px auto 0;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  color: #FFF;\n}\n\n.programCalendar ion-item ion-label.active p {\n  color: #2bbbad;\n}\n\n.programCalendar + .top-segment + div .no-data {\n  height: calc(100vh - 298px);\n}\n\n.upcomingCard {\n  border-radius: 0;\n  box-shadow: none;\n  border-bottom: 5px solid #f7f7f7;\n}\n\n.upcomingCard ion-avatar {\n  width: 65px;\n  height: 65px;\n}\n\n.upcomingCard ion-label {\n  line-height: 1.5;\n}\n\n.swiper-wrapper .slide-container .weekview-allday-table {\n  display: none !important;\n}\n\nion-slides.slides-container.md.slides-md.swiper-container.hydrated.swiper-container-initialized.swiper-container-horizontal {\n  background: #27A69A !important;\n}\n\n.table-bordered {\n  border: none !important;\n}\n\n.table-bordered > thead > tr > th, .table-bordered > tbody > tr > th, .table-bordered > tfoot > tr > th, .table-bordered > thead > tr > td, .table-bordered > tbody > tr > td, .table-bordered > tfoot > tr > td {\n  border: none !important;\n}\n\ntd, th {\n  border: 0 !important;\n}\n\n.calendar {\n  background: #27A69A !important;\n}\n\n::ng-deep .weekview-allday-table {\n  display: none !important;\n}\n\n::ng-deep ion-slides.slides-container.md.slides-md.swiper-container.hydrated.swiper-container-initialized.swiper-container-horizontal {\n  background: #27A69A !important;\n}\n\n::ng-deep td, ::ng-deep th {\n  border: 0 !important;\n}\n\n::ng-deep .table-bordered {\n  border: 0 !important;\n}\n\n::ng-deep .slides-container {\n  color: #fff !important;\n  background: #27A69A !important;\n}\n\n::ng-deep .list-ios {\n  margin-bottom: 0 !important;\n}\n\n::ng-deep .table > thead > tr > th.weekview-header {\n  font-size: 13px !important;\n  font-weight: 500;\n  padding-top: 15px;\n  padding-bottom: 15px;\n}\n\n::ng-deep ion-title.ios.title-ios.title-default.hydrated {\n  padding-inline: 0px;\n}\n\n::ng-deep th.weekview-header.text-center.weekview-selected {\n  background: #fff;\n  color: #27a69a;\n}\n\n::ng-deep .calendar-hour-column {\n  display: none !important;\n}\n\n.list-person {\n  white-space: nowrap;\n  text-overflow: ellipsis;\n}\n\n.flex-card {\n  display: flex;\n  align-items: center;\n}\n\np.text-green {\n  font-size: 14px;\n}\n\n.divider-line {\n  width: 2px;\n  height: 50px;\n  margin: 0 20px;\n  background-color: #000;\n}\n\n.title__div {\n  width: 10%;\n}\n\n.primary-color {\n  color: #27a69a;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
      ...
      _createClass(ProgramPage, [{
        ...
        value: function onTimeSelected(event) {
          ...
          this.programService.getAllSelectedUpcomingPrograms({
            ...
            console.log(data);
            _this2.allScheduleList = data.data.filter(function (el) {
              if (el.image_path) {
            ...
            _this2.pgCount = _this2.allScheduleList.length;

            _this2.commonService.dismissLoader();

            if (_this2.allScheduleList.length < 1) {
              _this2.noAllScheduleList = true;
            }
          }, function (err) {
        ...
        value: function mySortDate(selectedDate, index) {
          ...
          this.programService.getSchedulePrograms({
            ...
            console.log(_this7.pgCount, 'count');

            if (_this7.scheduleList.length < 1) {
              _this7.noScheduleList = true; // this.noAllScheduleList = true;
            }
          }, function (err) {
