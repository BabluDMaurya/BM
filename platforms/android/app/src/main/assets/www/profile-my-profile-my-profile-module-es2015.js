...
let MyProfilePage = class MyProfilePage {
    constructor(router, route, platform, alertCtrl, commonService, settingsService, peopleView, notification, modalController, popoverController, navController, toastController) {
        this.router = router;
        this.route = route;
    ...
    ngOnInit() {
        ...
        this.peopleView.getMyPost('1', '', 1).subscribe((data) => {
            if (data.status == 401) {
                this.commonService.loggingout();
            }
            if (data.status == 500) {
    ...
    videoPostData() {
        ...
        this.peopleView.getMyPost('2', this.loginUserData.id, 1).subscribe((data) => {
    ...
    loadVideoData(event) {
        setTimeout(() => {
            if (this.currentPage > 0) {
                this.peopleView.getMyPost('2', this.loginUserData.id, (this.currentPage + 1)).subscribe((data) => {
