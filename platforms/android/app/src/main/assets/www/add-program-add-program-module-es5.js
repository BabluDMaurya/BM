        ...
        value: function openStart(i) {
          ...
          if (this.myDate != '' && this.progDuration.length > 0) {
            if (this.repetatedDateCopy[this.indexForLive].is_live == true) {
              ...
              this.repetatedDateCopy[this.indexForLive].is_live = true; // this.repetatedDate[this.indexForLive] = this.dateObj;
                        ...
                        handler: function handler(data) {
                          ...
                          if (data.duration <= 0) {
                            ...
                            if (_this13.noEvent == true) {
                              ...
                              _this13.repetatedDate = _this13.repetatedDate; // if (this.repetatedDateCopy[this.indexForLive].is_live == true) {
                              //   this.repetatedDateCopy[this.indexForLive].is_live = false;
                              // } else {
