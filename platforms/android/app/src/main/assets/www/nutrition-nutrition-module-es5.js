...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["nutrition-nutrition-module"], {
    ...
    var NutritionPreviewComponent = /*#__PURE__*/function () {
      function NutritionPreviewComponent(commonService, nutritionService, navCtrl, router, fb) {
        ...
        this.nutritionService.currentNutritionData.subscribe(function (data) {
          ...
          console.log(_this.nutritionData);
  ...
  function srcAppNutritionNutritionPageScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "ion-input {\n  color: #222 !important; }\n\n.btn-add {\n  position: absolute;\n  right: 0; }\n\n.ingredientsBlock ion-list ion-button {\n  bottom: 10px; }\n\n.ingredientsBlock ion-button {\n  top: 36px; }\n\n.instructionsBlock ion-list ion-button {\n  bottom: 10px; }\n\n.instructionsBlock ion-button {\n  top: 38px; }\n\nion-segment.top-segment {\n  height: 40px; }\n\nion-segment.top-segment ion-segment-button {\n    min-height: 40px; }\n\nion-segment.top-segment ion-segment-button ion-label {\n      margin: 0;\n      color: #000;\n      font-size: 0.75rem; }\n\nion-slides ion-slide img {\n  height: 250px;\n  width: 100%;\n  -o-object-fit: cover;\n     object-fit: cover;\n  -o-object-position: center;\n     object-position: center; }\n\nion-slides ion-slide ion-icon {\n  position: absolute;\n  right: 15px;\n  top: 0;\n  font-size: 28px;\n  color: red; }\n\nion-slides ion-slide div {\n  height: 100%;\n  display: flex;\n  height: 275px; }\n\nion-slides ion-slide div img {\n    -o-object-fit: contain;\n       object-fit: contain; }\n\nion-slides ion-slide div ion-icon {\n    position: absolute;\n    right: 8px;\n    top: 8px;\n    width: 24px;\n    height: 24px; }\n\nion-item.floatingItem ion-label {\n  color: #a5a4a4; }\n\nion-item.floatingItem ion-textarea {\n  margin-top: 0; }\n\n.nutrition-box {\n  display: flex;\n  align-items: center; }\n\n.img-container {\n  width: 45px;\n  height: 45px;\n  border-radius: 5px;\n  margin-right: 12px; }\n\n.img-container img {\n  width: 100%;\n  height: 100%;\n  -o-object-fit: cover;\n     object-fit: cover;\n  -o-object-position: center;\n     object-position: center; }\n\n.nutrition-title {\n  font-size: 1rem;\n  color: #121212;\n  font-weight: 500; }\n\n.nutrition-container {\n  flex: 1; }\n\n.nutrition-details {\n  display: flex;\n  align-items: center;\n  margin-top: 10px; }\n\n.nutrition-left {\n  display: flex;\n  flex: 1; }\n\n.nutrition-right span {\n  font-size: 13px;\n  color: #8b8b8b; }\n\n.nutrition-quantity {\n  display: flex;\n  align-items: center;\n  margin-right: 8px; }\n\n.nutrition-input {\n  border: 0.5px solid #bbb;\n  border-radius: 5px;\n  max-width: 50px;\n  height: 30px;\n  margin: 0 5px; }\n\n.nutrition-select {\n  border: 0.5px solid #bbb;\n  border-radius: 5px;\n  min-width: 100px;\n  width: 100px;\n  height: 30px;\n  font-size: 13px;\n  position: relative;\n  -webkit-padding-start: 8px !important;\n          padding-inline-start: 8px !important;\n  margin-right: 8px; }\n\n.closeicon {\n  color: #2e2d2d !important; }\n\n.roundedcorner {\n  width: 100% !important;\n  border-radius: 0 !important; }\n\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  function srcAppNutritionNutritionPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var NutritionPage = /*#__PURE__*/function () {
      ...
      _createClass(NutritionPage, [{
        ...
        key: "addIngredients",
        value: function addIngredients(inputNew) {
          var numberOfTickets = 1; // this.tig.push(this.fb.group({
          //   name: ['']
          // }));

          var data = [];
          data[0] = {
            mn: this.f.nutriIngredients.value[0].name
          };
          this.scanData.push({
            data: data
          });
        ...
        key: "onQtyChange",
        value: function onQtyChange(i, food, val) {
