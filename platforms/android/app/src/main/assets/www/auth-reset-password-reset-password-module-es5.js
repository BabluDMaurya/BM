...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["auth-reset-password-reset-password-module"], {
  ...
  function srcAppAuthResetPasswordResetPasswordPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _helpers_formvalidator__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    ...
    var ResetPasswordPage = /*#__PURE__*/function () {
      function ResetPasswordPage(formBuilder, router, storage, authService, commonService, activatedRoute) {
        var _this = this;
        ...
        this.validation_messages = {
          ...
          'newPassword': [{
            ...
            type: 'pattern',
            message: 'Password must be at least 8 characters,  1 Uppercase , 1 number , 1 Special character'
          }, {
            type: 'mustMatch',
        ...
        this.activatedRoute.paramMap.subscribe(function (params) {
          _this.email = params.get('emailid');
        });
      }
      ...
      _createClass(ResetPasswordPage, [{
        ...
        value: function ngOnInit() {
          this.loginForm = this.formBuilder.group({
            ...
            newPassword: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]('', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].compose([_validators_password_validator__WEBPACK_IMPORTED_MODULE_3__["PasswordValidator"].areEqual, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].maxLength(25), _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].minLength(5), _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].pattern('^(?=.*?[A-Z])(?=.*?[a-z])(?=.*?[0-9])(?=.*?[#?!@$%^&*-]).{8,}$'), _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required])),
        ...
        value: function onSubmit() {
          ...
          this.authService.updatePassword(this.loginForm.value).subscribe(function (data) {
            console.log(data);
            ...
            if (data.status == true) {
              ...
              _this2.commonService.presentToast(data.message);
            } else {
              _this2.commonService.dismissLoader();
    ...
    ResetPasswordPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./src/app/auth/reset-password/reset-password.page.scss"))["default"], tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./../../app.component.scss */
      "./src/app/app.component.scss"))["default"]]
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"], _angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"], _ionic_storage__WEBPACK_IMPORTED_MODULE_6__["Storage"], _services_auth_service__WEBPACK_IMPORTED_MODULE_4__["AuthService"], _services_common_service__WEBPACK_IMPORTED_MODULE_8__["CommonService"], _angular_router__WEBPACK_IMPORTED_MODULE_5__["ActivatedRoute"]])], ResetPasswordPage);
    /***/
  }
}]);
