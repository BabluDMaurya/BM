...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["user-profile-user-profile-module"], {
  ...
  function srcAppUserProfileUserProfilePageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _services_home_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! ../services/home.service */
    "./src/app/services/home.service.ts");
    /* harmony import */


    var _modalContent_followers_followers_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    /*! ../modalContent/followers/followers.component */
    "./src/app/modalContent/followers/followers.component.ts");
    /* harmony import */


    var _services_people_view_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    ...
    /*! @angular/router */
    "./node_modules/@angular/router/fesm2015/router.js"); // import { RouterOutlet, Router, ActivationStart } from '@angular/router';
    ...
    var UserProfilePage = /*#__PURE__*/function () {
      function UserProfilePage(commonService, homeService, popoverController, settingsService, platform, programService, modalController, peopleView, router) {
        ...
        this.router = router; // @ViewChild(RouterOutlet,{ static: false }) outlet: RouterOutlet;
      ...
      _createClass(UserProfilePage, [{
        ...
        value: function getMyprog() {
          ...
          this.programService.getUpcomingPrograms(null).subscribe(function (data) {
            ...
            console.log(data);
            console.log(_this2.noData + 'this.noData');
            ...
            _this2.upcomingList = data.programList.filter(function (el) {
              ...
              el.expanded = false;
              console.log(_this2.upcomingList, 'fff');
              return el;
            });
          });
        }
        ...
        value: function ionViewWillEnter() {
          ...
          this.programService.getUpcomingPrograms(null).subscribe(function (data) {
            console.log(data);
            _this3.upcomingProgram = data.programList.filter(function (el) {
              if (el.image_path != '') {
                el.img_arr = el.image_path.split(',');
              } else {
                el.img_arr = _this3.profileDefaultImage;
              }
            ...
            console.log(_this3.upcomingProgram);
          });
        }
      }, {
        key: "ngAfterViewInit",
        ...
        value: function like_bookmark(arr) {
          ...
          arr.filter(function (element, i) {
            ...
            element.post_likes.filter(function (f) {
              if (f.user_id == _this5.userData.id) {
                element.liked = true;
              }
            });
        ...
        value: function notification1() {
          this.commonService.presentModal(_modalContent_followers_followers_component__WEBPACK_IMPORTED_MODULE_10__["FollowersComponent"], 'fullModal', {
        ...
        value: function bookmarked(postId, bmStat, post_type) {
          ...
          this.postData.forEach(function (element, i) {
            if (element.id == postId) {
              _this6.postData[i].bookmarked = !bmStat;
            }
          }); //console.log(postId, bmStat);
        ...
        value: function liked(postId, likeStat) {
          ...
          this.postData.forEach(function (element, i) {
            if (element.id == postId) {
              _this7.postData[i].liked = !likeStat;

              if (likeStat) {
                _this7.postData[i].count = _this7.postData[i].count - 1;
              } else {
                _this7.postData[i].count = _this7.postData[i].count + 1;
              }
            }
        ...
        value: function loadData(event) {
          ...
          setTimeout(function () {
            if (_this8.currentPage > 0) {
              _this8.homeService.getUsersFollowingContent({
                'page': _this8.currentPage + 1
              }).subscribe(function (data) {
                event.target.complete();
                _this8.postData = _this8.postData.concat(_this8.like_bookmark(data.postData.data));
                console.log(_this8.postData);
                console.log('postData'); // this.remainingTopConsultent = this.remainingTopConsultent;

                _this8.last_page = data.postData.last_page;
                _this8.currentPage = data.postData.current_page;
              });
            }

            if (_this8.last_page <= _this8.currentPage + 1) {
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_app_services_common_service__WEBPACK_IMPORTED_MODULE_3__["CommonService"], _services_home_service__WEBPACK_IMPORTED_MODULE_9__["HomeService"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["PopoverController"], _services_settings_service__WEBPACK_IMPORTED_MODULE_6__["SettingsService"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["Platform"], _services_program_service__WEBPACK_IMPORTED_MODULE_7__["ProgramService"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"], _services_people_view_service__WEBPACK_IMPORTED_MODULE_11__["PeopleViewService"], _angular_router__WEBPACK_IMPORTED_MODULE_13__["Router"]])], UserProfilePage);
    /***/
  }
}]);
