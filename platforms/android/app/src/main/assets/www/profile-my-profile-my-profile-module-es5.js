...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["profile-my-profile-my-profile-module"], {
  ...
  function srcAppProfileMyProfileMyProfilePageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var MyProfilePage = /*#__PURE__*/function () {
      function MyProfilePage(router, route, platform, alertCtrl, commonService, settingsService, peopleView, notification, modalController, popoverController, navController, toastController) {
        var _this = this;
      ...
      _createClass(MyProfilePage, [{
        ...
        value: function ngOnInit() {
          ...
          this.peopleView.getMyPost('1', '', 1).subscribe(function (data) {
            if (data.status == 401) {
        ...
        value: function videoPostData() {
          ...
          this.peopleView.getMyPost('2', this.loginUserData.id, 1).subscribe(function (data) {
        ...
        value: function loadVideoData(event) {
          ...
          setTimeout(function () {
            if (_this5.currentPage > 0) {
              _this5.peopleView.getMyPost('2', _this5.loginUserData.id, _this5.currentPage + 1).subscribe(function (data) {
                  ...
                  case 3:
                    ...
                    popover.onDidDismiss().then(function (data) {
                      if (data.data.click == 1) {
                        _this8.myPosts.forEach(function (f, i) {
                          if (f.id == ev) {
                            _this8.myPosts[i].is_delete = 1;
                          }
                        });
                      } else if (data.data.click == 2) {
                        _this8.myPosts.forEach(function (f, i) {
                          if (f.id == ev) {
                            _this8.myPosts[i].disable_comment = !commentStatus;
                          }
                        });
                      }
                    });
