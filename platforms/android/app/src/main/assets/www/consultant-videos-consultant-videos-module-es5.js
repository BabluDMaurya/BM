...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["consultant-videos-consultant-videos-module"], {
  ...
  function srcAppConsultantVideosConsultantVideosModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    ConsultantVideosPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _consultant_videos_routing_module__WEBPACK_IMPORTED_MODULE_5__["ConsultantVideosPageRoutingModule"]],
        ...
        value: function loadVideoData(event) {
          ...
          setTimeout(function () {
            if (_this4.currentPage > 0) {
              _this4.peopleView.getExclusiveVedioType('2', _this4.userId, 2, _this4.currentPage + 1).subscribe(function (data) {
                ...
                _this4.myPosts = _this4.myPosts.concat(data.posts.data);
            ...
            if (_this4.last_page <= _this4.currentPage + 1) {
        ...
        value: function liked(postId, likeStat) {
          ...
          this.myPosts.forEach(function (element, i) {
            if (element.id == postId) {
              _this5.myPosts[i].liked = !likeStat;

              if (likeStat) {
                _this5.myPosts[i].count = _this5.myPosts[i].count - 1;
              } else {
                _this5.myPosts[i].count = _this5.myPosts[i].count + 1;
              }
            }
